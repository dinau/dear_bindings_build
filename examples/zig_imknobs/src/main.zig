...
pub fn main() !void {
    ...
    while (ig.glfwWindowShouldClose(window) == 0) {
        ...
        //-----------------------
        {
            _ = ig.ImGui_Begin("ImKnobs: Dear Bindings in Zig  2025/07 " ++ c.ICON_FA_DOG, null, 0);
            defer ig.ImGui_End();
            const st = struct {
                var val1: f32 = 0;
                var val2: f32 = 0;
