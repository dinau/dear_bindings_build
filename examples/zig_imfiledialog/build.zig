...
pub fn build(b: *std.Build) void {
    ...
    // ImFileDialog
    exe.addIncludePath(b.path("../../libs/CImGuiFileDialog"));
    exe.addIncludePath(b.path("../../libs/CImGuiFileDialog/libs/ImGuiFileDialog"));
    exe.root_module.addCMacro("CUSTOM_IMGUIFILEDIALOG_CONFIG", "\"customIconFont.h\"");
    ...
    exe.addCSourceFiles(.{
        .files = &.{
            ...
            // CImGui SDL interfac       //"../libs/cimgui/cimgui_impl_sdl2.cpp",
