...
pub fn main() !void {
    ...
    while (ig.glfwWindowShouldClose(window) == 0) {
        ...
        //------------------------
        {
            _ = ig.ImGui_Begin("ImSpinner demo " ++ c.ICON_FA_DOG, null, 0);
            defer ig.ImGui_End();
            ig.demoSpinners(); // Defined by "IMSPINNER_DEMO" in ../build.zig
        }
        ...
        //-----------------------
        {
            _ = ig.ImGui_Begin("ImSpinner: Dear Bindings in Zig " ++ c.ICON_FA_CAT, null, 0);
            defer ig.ImGui_End();
            ...
            ig.ImGui_SameLine(); // Defined by "SPINNER_DNADOTS" in cimspinner_config.h by default
            ...
            ig.SpinnerCamera("Camera", 16, 8, st.genColor); // Defined by "SPINNER_CAMERA" in ../build.zig
            ig.ImGui_NewLine();
